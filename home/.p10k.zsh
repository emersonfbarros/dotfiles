...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local     added='%50F' # green foreground
    else
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="%f${clean}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}%F{3}(%f%F${clean}${branch//\%/%%}%f"
    fi
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{blue}[%f%n%F{red}@%f%m%F{blue}]%f %F{011}➜%f'
  ...
  # Node version color.
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND=28
  ...
  # Rust version color.
  typeset -g POWERLEVEL9K_RUST_VERSION_FOREGROUND=172
  ...
  # .NET version color.
  typeset -g POWERLEVEL9K_DOTNET_VERSION_FOREGROUND=25
