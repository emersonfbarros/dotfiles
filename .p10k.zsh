...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%115F'  # green foreground
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      res+="%F{011}(%f${clean}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
    fi
  ...
  # typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='[\[\033[38;5;33m%n@%m\]]'
  # typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='[\[\018[38;5;018m\]%n@%m\]'
  # typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='033[38;5;33m%n@%m]'
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{blue}[%f%n%F{red}@%f%m%F{blue}]%f %F{011}󰜴%f'
