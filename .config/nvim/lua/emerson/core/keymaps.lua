...
-- vim.keymap.set('n', '<leader>fe', ':25Lex<CR>', { silent = true })
...
vim.keymap.set('n', '<leader>cb', '<cmd>bp|bd #<CR>', { desc = '[C]lose [B]uffer', silent = true })
...
vim.keymap.set('n', '<leader>ta', ':set splitright | vnew | set filetype=sh | read !sh #<CR>', { silent = true, desc = '[T]est [A]pi' })
